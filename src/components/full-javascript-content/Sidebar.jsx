        ...
        <li className="mb-4">
          ...
          {isOpen['nodeJs'] && (
            <ul className="pl-6 mt-2 space-y-2">
              ...
              { label: "Variables & Data Types", icon: <FaCubes className="inline mr-2 text-xl" />, href: "/javascript/variables" },
              ...
              { label: "DOM Manipulation", icon: <FaHtml5 className="inline mr-2 text-xl" />, href: "/javascript/dom" },
              { label: "Events", icon: <FaMousePointer className="inline mr-2 text-xl" />, href: "/javascript/events" },
              { label: "ES6+ Features", icon: <FaBolt className="inline mr-2 text-xl" />, href: "/javascript/es6" },
