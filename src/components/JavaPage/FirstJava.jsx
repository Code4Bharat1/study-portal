...
export default function JavaPage() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#fff7e6] via-[#fff1cc] to-[#ffeb99] animate-gradient-shift flex items-center justify-center p-4">
      ...
      <FaJava className="absolute bottom-20 right-[10%] text-red-600 text-5xl z-34" />
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          >
            ...
            <motion.p
              ...
              variants={itemVariants}
            >
              Create scalable, object-oriented applications with Java, a
            ...
            >
              ...
              <div className="flex flex-wrap gap-2">
                {["Oracle", "IBM", "Red Hat", "SAP", "Android", "Netflix"].map(
                  (company, i) => (
                    <motion.span
                      key={company}
        ...
        System.out.println(name + " is " + age + " years old.");
              ...
              >
                <p className="text-gray-600 mb-4">
                  Try Java right in your browser
                </p>
