  ...
  return (
    <div className="p-6 ml-72">
      ...
      <div className="bg-white p-6 rounded-xl shadow-lg max-w-5xl mx-auto">
        <h2 className="text-2xl font-semibold text-yellow-500 mb-4">Step 1: Initialize a Node.js Project</h2>
...
npm init -y`}
        ...
        <h2 className="text-2xl font-semibold text-yellow-500 mb-4">Step 2: Install Express</h2>
        <p className='text-gray-800'>
        ...
        <h2 className="text-2xl font-semibold text-yellow-500 mb-4">Step 3: Create Your First Server</h2>
        <p className='text-gray-800'>
          Now, create a file called <code>server.js</code> and add the following code:
        </p>
...
app.listen(3000, () => {
  console.log('Server is running on port 3000');
        ...
        <p className='text-gray-800'>
          Visit <code>http://localhost:3000</code> in your browser to see your Express server in action!
        </p>

        <h2 className="text-2xl font-semibold text-yellow-500 mb-4">What's Next?</h2>
        <p className='text-gray-800  '>
          Now that your setup is complete, you're ready to explore routing, middleware, and building real APIs with Express. Let's move on and create more powerful applications!
        </p>
