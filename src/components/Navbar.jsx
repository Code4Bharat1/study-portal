              ...
              <div className="flex space-x-8">
                {navbarItems.map((item, index) => (
                  <Link
                    key={index}
                    href={item.link}
                    className={`px-1 py-2 text-sm font-medium hover:text-blue-500 border-b-2 border-transparent hover:border-black transition-all duration-300 ${
                      pathname === item.link
                        ? "text-blue-500 border-black"
                        : "text-gray-800"
                    }`}
                  >
                    {item.name}
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <div className="relative" ref={searchRef}>
                <input
                  ...
                  className="px-4 py-1.5 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-400 text-sm w-40 transition-all duration-300 focus:w-52"
                />
          ...
          <div className="fixed inset-y-0 right-0 max-w-xs w-full bg-white shadow-xl">
            ...
            <div className="px-6 py-4 space-y-4">
              ...
              <div className="pt-4 border-t border-gray-200 space-y-2">
                <Link href="/login">
                  <button
                    className="w-full px-4 py-2 rounded-full border border-gray-300 text-gray-800 text-sm font-medium hover:border-blue-500 hover:text-blue-600 transition-colors"
                    onClick={() => setMobileMenuOpen(false)}
                  >
                    Log In
                  </button>
                ...
                <Link href="/register">
                  <button
                    className="w-full px-4 py-2 rounded-full bg-gradient-to-r from-blue-500 to-blue-700 text-white text-sm font-medium hover:from-blue-600 hover:to-blue-800 transition-all"
                    onClick={() => setMobileMenuOpen(false)}
                  >
                    Sign Up
                  </button>
