    ...
    <div className="p-6 ml-80">
      ...
      <div className="bg-white p-6  max-w-8xl mx-auto">
        ...
        <p className="text-gray-800 text-md leading-relaxed mb-6">
          PHP (Hypertext Preprocessor) ek server-side scripting language hai jiska use dynamic websites banane ke liye kiya jata hai. Yeh free hai, open-source hai aur website ke backend mein kaam karta hai.
        </p>
        ...
        <ul className="list-disc list-inside text-sm text-gray-800 space-y-2 mb-6">
          ...
          <li>PHP ka code server pe chalta hai aur browser mein HTML ke roop mein result dikhta hai.</li>
        ...
        <ul className="list-disc list-inside text-sm text-gray-800 space-y-2 mb-6">
          <li>Open-source aur free of cost.</li>
          <li>Fast execution speed.</li>
          <li>Database se connect kar sakta hai (jaise MySQL).</li>
        ...
        <ul className="list-disc list-inside text-sm text-gray-800 space-y-2 mb-6">
          ...
          <li>File system ke sath kaam karna (file create, read, write, delete)</li>
        ...
        <p className="text-sm text-gray-800 leading-relaxed mb-4">
          PHP code <code>&lt;?php ... ?&gt;</code> ke andar likha jata hai. Yeh server par run hota hai aur result HTML ke form mein browser ko milta hai.
        </p>
  ...
  <body>
    ...
    ?>
        ...
        <p className="text-sm text-gray-800 mb-6">
          PHP file ka extension hota hai: <code>.php</code><br/>
        ...
        <ol className="list-decimal list-inside text-sm text-gray-800 space-y-2 mb-6">
          <li>Client (user) browser mein request bhejta hai.</li>
          <li>Server pe PHP file run hoti hai.</li>
          <li>PHP server-side pe HTML generate karta hai.</li>
          <li>Browser mein HTML output dikhta hai (PHP code nahi dikhta).</li>
        </ol>
