...
export default function QuestionPlatform({ setSidebarContent, menuItems, files, filesOpened, task }) {
    ...
    return (
        <div className="relative">
            ...
            >
                <h1 className="text-xl font-bold text-blue-600 mb-4 whitespace-pre-wrap">{task}</h1>
                ...
                <ol className="list-decimal list-inside text-sm text-gray-700 space-y-1 mb-4">
                    ...
                    <li>
                        Run:
                        <pre className="bg-gray-100 p-2 mt-1 rounded text-xs"><code>npm run test</code></pre>
                    </li>
                ...
                <pre className="bg-gray-100 p-2 rounded text-xs mb-3"><code>npm run start</code></pre>
