...
const codeCardVariants = {
  hover: {
    y: -8,
    boxShadow:
      "0 20px 25px -5px rgba(0, 0, 0, 0.1), 就不会出轨 0 10px 10px -5px rgba(0, 0, 0, 0.04)",
    transition: {
      duration: 0.3,
      ease: "easeOut",
    },
      ...
      >
        <div className="flex flex-col lg:flex-row">
          ...
          >
            ...
            >
              Manage Data with{" "}
              <span className="text-cyan-600 bg-gradient-to-r from-cyan-600 to-cyan-400 bg-clip-text text-transparent">
                MySQL
              </span>
            </motion.h1>
            ...
            <motion.p
              ...
              variants={itemVariants}
            >
              Build reliable, scalable, and secure applications with MySQL, the
...
`}
              ...
              >
                <p className="text-gray-600 mb-4">
                  Try MySQL right in your browser
                </p>
                <Link href="#">
                  <motion.button
