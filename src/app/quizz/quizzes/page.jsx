...
import { FaDatabase, FaNodeJs, FaReact, FaTrophy, FaUser, FaHistory } from 'react-icons/fa';
...
const quizData = [
  ...
  },
  {
    ...
    btnColor: 'bg-gradient-to-r from-gray-500 to-gray-600 hover:from-gray-600 hover:to-gray-700',
  },
  {
    title: 'React Quiz',
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-gray-800">
                  {isLoading
                    ? '...'
                    : Object.keys(userScores[session?.user?.email] || {}).length}
                </p>
              </div>
            </div>
          </motion.div>
              ...
              <div>
                ...
                <p className="text-xl font-bold text-gray-800">
                  {isLoading
                    ? '...'
                    : session?.user?.email && userScores[session.user.email]
                      ? Math.max(...Object.values(userScores[session.user.email])) + '%'
                      : '0%'}
                </p>
              </div>
            </div>
                ...
                <div className="p-6 flex flex-col items-center text-center h-full">
                  ...
                  {bestScore !== null && (
                    <div className="w-full bg-white bg-opacity-70 rounded-full mb-4">
                      ...
                      ></div>
                      <p className="text-xs mt-1 text-gray-600">Your best: {bestScore}%</p>
                    </div>
                  )}
