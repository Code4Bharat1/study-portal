  ...
  return (
    <main className="min-h-screen bg-purple-100 px-4 py-10">
      <div className="max-w-6xl mx-auto">
        ...
        <h1 className="text-5xl font-bold text-black mb-8 text-center">Node.js Projects</h1>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-12">
          <h2 className="text-2xl font-semibold text-black mb-4">Practice Node.js Code</h2>
          <p className="text-black mb-4">Write and test your Node.js code below. Click "Run Code" to execute it.</p>
          <textarea
