// Simple Browser-Compatible Test for NPM and Package Management
...
function runSimpleTest(userCode) {
    ...
    try {
        ...
        const topic = "NPM and Package Management".toLowerCase();
...
if (typeof window !== 'undefined') {
    window.exerciseTest = {
        ...
        testConfig: {topic: "NPM and Package Management", language: "nodejs"}
    };
}
