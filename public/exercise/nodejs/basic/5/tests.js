// Simple Browser-Compatible Test for Asynchronous Programming
...
function runSimpleTest(userCode) {
    ...
    try {
        ...
        const topic = "Asynchronous Programming".toLowerCase();
...
if (typeof window !== 'undefined') {
    window.exerciseTest = {
        ...
        testConfig: {topic: "Asynchronous Programming", language: "nodejs"}
    };
}
