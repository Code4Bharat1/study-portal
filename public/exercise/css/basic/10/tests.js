// Simple Browser-Compatible Test for CSS Inheritance
// No external dependencies - works entirely in browser

console.log("🧪 Testing: CSS Inheritance");
...
function runSimpleTest(userCode) {
    ...
    try {
        ...
        const topic = "CSS Inheritance".toLowerCase();
...
if (typeof window !== 'undefined') {
    window.exerciseTest = {
        ...
        testConfig: {topic: "CSS Inheritance", language: "css"}
    };
}

console.log("✅ Test ready for: CSS Inheritance");