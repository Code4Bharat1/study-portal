# CSS Basic Exercise 9: CSS Units and Values

## 🎯 Learning Objectives
- Understand css units and values concepts
- Practice css programming fundamentals
- Apply best practices and coding standards
- Develop problem-solving skills

## 📋 Task Description
Work with different CSS units: px, em, rem, %, vh, vw.
...
- CSS Units and Values fundamentals
