// Simple Browser-Compatible Test for Query Operators
// No external dependencies - works entirely in browser

console.log("🧪 Testing: Query Operators");
...
function runSimpleTest(userCode) {
    ...
    try {
        ...
        const topic = "Query Operators".toLowerCase();
...
if (typeof window !== 'undefined') {
    window.exerciseTest = {
        ...
        testConfig: {topic: "Query Operators", language: "mongodb"}
    };
}

console.log("✅ Test ready for: Query Operators");