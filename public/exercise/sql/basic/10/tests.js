// Simple Browser-Compatible Test for Basic Indexing
...
function runSimpleTest(userCode) {
    ...
    try {
        ...
        const topic = "Basic Indexing".toLowerCase();
...
if (typeof window !== 'undefined') {
    window.exerciseTest = {
        ...
        testConfig: {topic: "Basic Indexing", language: "sql"}
    };
}

console.log("✅ Test ready for: Basic Indexing");