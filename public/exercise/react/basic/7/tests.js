// Simple Browser-Compatible Test for Component Lifecycle
...
function runSimpleTest(userCode) {
    ...
    try {
        ...
        const topic = "Component Lifecycle".toLowerCase();
...
if (typeof window !== 'undefined') {
    window.exerciseTest = {
        ...
        testConfig: {topic: "Component Lifecycle", language: "react"}
    };
}

console.log("✅ Test ready for: Component Lifecycle");