# Simple Browser-Compatible Test for Data Analysis with Pandas
# No external dependencies - works entirely in browser

print("🧪 Testing: Data Analysis with Pandas")
...
def run_simple_test(user_code):
    ...
    try:
        ...
        topic_lower = "Data Analysis with Pandas".lower()
...
print("✅ Test ready for: Data Analysis with Pandas")