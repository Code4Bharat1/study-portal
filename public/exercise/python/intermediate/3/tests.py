# Simple Browser-Compatible Test for Decorators and Generators
# No external dependencies - works entirely in browser

print("🧪 Testing: Decorators and Generators")
...
def run_simple_test(user_code):
    ...
    try:
        ...
        topic_lower = "Decorators and Generators".lower()
...
print("✅ Test ready for: Decorators and Generators")