# Simple Browser-Compatible Test for Working with APIs
# No external dependencies - works entirely in browser

print("🧪 Testing: Working with APIs")
...
def run_simple_test(user_code):
    ...
    try:
        ...
        topic_lower = "Working with APIs".lower()
...
print("✅ Test ready for: Working with APIs")