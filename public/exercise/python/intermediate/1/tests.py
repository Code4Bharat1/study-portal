# Simple Browser-Compatible Test for Object-Oriented Programming
# No external dependencies - works entirely in browser

print("🧪 Testing: Object-Oriented Programming")
...
def run_simple_test(user_code):
    ...
    try:
        ...
        topic_lower = "Object-Oriented Programming".lower()
...
print("✅ Test ready for: Object-Oriented Programming")