# Simple Browser-Compatible Test for Lambda Functions and Map/Filter
# No external dependencies - works entirely in browser

print("🧪 Testing: Lambda Functions and Map/Filter")
...
def run_simple_test(user_code):
    ...
    try:
        ...
        topic_lower = "Lambda Functions and Map/Filter".lower()
...
print("✅ Test ready for: Lambda Functions and Map/Filter")