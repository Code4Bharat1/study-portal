# Python Basic Exercise 4: Conditional Statements

## 🎯 Learning Objectives
- Understand conditional statements concepts
- Practice python programming fundamentals
- Apply best practices and coding standards
- Develop problem-solving skills

## 📋 Task Description
Use if-elif-else statements to control program flow.
...
- Conditional Statements fundamentals
