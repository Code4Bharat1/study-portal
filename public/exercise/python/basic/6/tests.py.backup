...
def code_verify():
    ...
    if for_loops == 0:
        ...
        print(f'✔ Found {for_loops} for loop(s)')
    if while_loops == 0:
        print('✘ No while loops found')
        all_passed = False
    else:
        print(f'✔ Found {while_loops} while loop(s)')

    if all_passed:
        print('\n🎉 Success! Loops implementation is correct.')
    else:
        print('\n❗ Loops check failed. Please review your Python code.')
    return all_passed
