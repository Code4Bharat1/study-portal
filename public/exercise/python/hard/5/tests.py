# Simple Browser-Compatible Test for Machine Learning Basics
# No external dependencies - works entirely in browser

print("🧪 Testing: Machine Learning Basics")
...
def run_simple_test(user_code):
    ...
    try:
        ...
        topic_lower = "Machine Learning Basics".lower()
...
print("✅ Test ready for: Machine Learning Basics")