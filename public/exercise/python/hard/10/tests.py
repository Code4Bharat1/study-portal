# Simple Browser-Compatible Test for Advanced Data Science
# No external dependencies - works entirely in browser

print("🧪 Testing: Advanced Data Science")
...
def run_simple_test(user_code):
    ...
    try:
        ...
        topic_lower = "Advanced Data Science".lower()
...
print("✅ Test ready for: Advanced Data Science")