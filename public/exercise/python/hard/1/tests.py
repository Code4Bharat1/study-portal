# Simple Browser-Compatible Test for Advanced OOP Patterns
# No external dependencies - works entirely in browser

print("🧪 Testing: Advanced OOP Patterns")
...
def run_simple_test(user_code):
    ...
    try:
        ...
        topic_lower = "Advanced OOP Patterns".lower()
...
print("✅ Test ready for: Advanced OOP Patterns")