# Simple Browser-Compatible Test for Async Programming with asyncio
# No external dependencies - works entirely in browser

print("🧪 Testing: Async Programming with asyncio")
...
def run_simple_test(user_code):
    ...
    try:
        ...
        topic_lower = "Async Programming with asyncio".lower()
...
print("✅ Test ready for: Async Programming with asyncio")