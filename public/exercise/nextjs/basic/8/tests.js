// Simple Browser-Compatible Test for Basic Data Fetching
// No external dependencies - works entirely in browser

console.log("🧪 Testing: Basic Data Fetching");
...
function runSimpleTest(userCode) {
    ...
    try {
        ...
        const topic = "Basic Data Fetching".toLowerCase();
...
if (typeof window !== 'undefined') {
    window.exerciseTest = {
        ...
        testConfig: {topic: "Basic Data Fetching", language: "nextjs"}
    };
}

console.log("✅ Test ready for: Basic Data Fetching");