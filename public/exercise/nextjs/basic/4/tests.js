...
async function functionalVerify() {
  ...
  try {
    ...
    if (data.textContent !== 'Server Data') {
      console.log('✘ Server data is not rendered');
      allPassed = false;
    } else {
      console.log('✔ Server data is rendered');
    }

    if (allPassed) {
      console.log('\n🎉 Success! Server-Side Rendering behavior is correct.');
    } else {
      console.log('\n❗ Server-Side Rendering behavior check failed. Please review your Next.js code.');
    }
    return allPassed;
  } catch (e) {
