// Simple Browser-Compatible Test for Static Assets and Images
// No external dependencies - works entirely in browser

console.log("🧪 Testing: Static Assets and Images");
...
function runSimpleTest(userCode) {
    ...
    try {
        ...
        const topic = "Static Assets and Images".toLowerCase();
...
if (typeof window !== 'undefined') {
    window.exerciseTest = {
        ...
        testConfig: {topic: "Static Assets and Images", language: "nextjs"}
    };
}

console.log("✅ Test ready for: Static Assets and Images");