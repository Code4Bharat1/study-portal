// Simple Browser-Compatible Test for Deployment Basics
// No external dependencies - works entirely in browser

console.log("🧪 Testing: Deployment Basics");
...
function runSimpleTest(userCode) {
    ...
    try {
        ...
        const topic = "Deployment Basics".toLowerCase();
...
if (typeof window !== 'undefined') {
    window.exerciseTest = {
        ...
        testConfig: {topic: "Deployment Basics", language: "nextjs"}
    };
}

console.log("✅ Test ready for: Deployment Basics");