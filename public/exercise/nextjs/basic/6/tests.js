...
async function functionalVerify() {
  ...
  try {
    ...
    if (postId.textContent !== 'Post ID: 123') {
      console.log('✘ Post ID is not rendered correctly');
      allPassed = false;
    } else {
      console.log('✔ Post ID is rendered correctly');
    }

    if (allPassed) {
      console.log('\n🎉 Success! Dynamic Routes behavior is correct.');
    } else {
      console.log('\n❗ Dynamic Routes behavior check failed. Please review your Next.js code.');
    }
    return allPassed;
  } catch (e) {
