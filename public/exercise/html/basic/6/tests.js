// Simple Browser-Compatible Test for Tables and Data
// No external dependencies - works entirely in browser

console.log("🧪 Testing: Tables and Data");
...
function runSimpleTest(userCode) {
    ...
    try {
        ...
        const topic = "Tables and Data".toLowerCase();
...
if (typeof window !== 'undefined') {
    window.exerciseTest = {
        ...
        testConfig: {topic: "Tables and Data", language: "html"}
    };
}

console.log("✅ Test ready for: Tables and Data");