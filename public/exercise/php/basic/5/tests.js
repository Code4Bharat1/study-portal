// Simple Browser-Compatible Test for Arrays and Associative Arrays
...
function runSimpleTest(userCode) {
    ...
    try {
        ...
        const topic = "Arrays and Associative Arrays".toLowerCase();
...
if (typeof window !== 'undefined') {
    window.exerciseTest = {
        ...
        testConfig: {topic: "Arrays and Associative Arrays", language: "php"}
    };
}
