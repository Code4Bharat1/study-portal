// Simple Browser-Compatible Test for Promises and Async/Await
...
function runSimpleTest(userCode) {
    ...
    try {
        ...
        const topic = "Promises and Async/Await".toLowerCase();
...
if (typeof window !== 'undefined') {
    window.exerciseTest = {
        ...
        testConfig: {topic: "Promises and Async/Await", language: "javascript"}
    };
}
