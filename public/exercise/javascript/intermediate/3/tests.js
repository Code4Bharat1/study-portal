// Simple Browser-Compatible Test for Array Methods (Map, Filter, Reduce)
...
function runSimpleTest(userCode) {
    ...
    try {
        ...
        const topic = "Array Methods (Map, Filter, Reduce)".toLowerCase();
...
if (typeof window !== 'undefined') {
    window.exerciseTest = {
        ...
        testConfig: {topic: "Array Methods (Map, Filter, Reduce)", language: "javascript"}
    };
}
