// Simple Browser-Compatible Test for Regular Expressions
...
function runSimpleTest(userCode) {
    ...
    try {
        ...
        const topic = "Regular Expressions".toLowerCase();
...
if (typeof window !== 'undefined') {
    window.exerciseTest = {
        ...
        testConfig: {topic: "Regular Expressions", language: "javascript"}
    };
}
