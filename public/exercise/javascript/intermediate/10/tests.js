// Simple Browser-Compatible Test for Advanced DOM Manipulation
// No external dependencies - works entirely in browser

console.log("🧪 Testing: Advanced DOM Manipulation");
...
function runSimpleTest(userCode) {
    ...
    try {
        ...
        const topic = "Advanced DOM Manipulation".toLowerCase();
...
if (typeof window !== 'undefined') {
    window.exerciseTest = {
        ...
        testConfig: {topic: "Advanced DOM Manipulation", language: "javascript"}
    };
}

console.log("✅ Test ready for: Advanced DOM Manipulation");