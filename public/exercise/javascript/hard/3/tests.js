// Simple Browser-Compatible Test for Advanced Array Manipulation
// No external dependencies - works entirely in browser

console.log("🧪 Testing: Advanced Array Manipulation");
...
function runSimpleTest(userCode) {
    ...
    try {
        ...
        const topic = "Advanced Array Manipulation".toLowerCase();
...
if (typeof window !== 'undefined') {
    window.exerciseTest = {
        ...
        testConfig: {topic: "Advanced Array Manipulation", language: "javascript"}
    };
}

console.log("✅ Test ready for: Advanced Array Manipulation");