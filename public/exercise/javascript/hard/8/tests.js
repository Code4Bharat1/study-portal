// Simple Browser-Compatible Test for Advanced Regular Expressions
...
function runSimpleTest(userCode) {
    ...
    try {
        ...
        const topic = "Advanced Regular Expressions".toLowerCase();
...
if (typeof window !== 'undefined') {
    window.exerciseTest = {
        ...
        testConfig: {topic: "Advanced Regular Expressions", language: "javascript"}
    };
}
