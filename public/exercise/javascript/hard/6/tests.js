// Simple Browser-Compatible Test for Advanced Event Handling
// No external dependencies - works entirely in browser

console.log("🧪 Testing: Advanced Event Handling");
...
function runSimpleTest(userCode) {
    ...
    try {
        ...
        const topic = "Advanced Event Handling".toLowerCase();
...
if (typeof window !== 'undefined') {
    window.exerciseTest = {
        ...
        testConfig: {topic: "Advanced Event Handling", language: "javascript"}
    };
}

console.log("✅ Test ready for: Advanced Event Handling");