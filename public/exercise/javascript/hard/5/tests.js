// Simple Browser-Compatible Test for Design Patterns in JavaScript
...
function runSimpleTest(userCode) {
    ...
    try {
        ...
        const topic = "Design Patterns in JavaScript".toLowerCase();
...
if (typeof window !== 'undefined') {
    window.exerciseTest = {
        ...
        testConfig: {topic: "Design Patterns in JavaScript", language: "javascript"}
    };
}
