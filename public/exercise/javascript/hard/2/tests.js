// Simple Browser-Compatible Test for Functional Programming Patterns
...
function runSimpleTest(userCode) {
    ...
    try {
        ...
        const topic = "Functional Programming Patterns".toLowerCase();
...
if (typeof window !== 'undefined') {
    window.exerciseTest = {
        ...
        testConfig: {topic: "Functional Programming Patterns", language: "javascript"}
    };
}
