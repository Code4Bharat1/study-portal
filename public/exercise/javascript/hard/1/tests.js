// Simple Browser-Compatible Test for Advanced Closures and IIFEs
...
function runSimpleTest(userCode) {
    ...
    try {
        ...
        const topic = "Advanced Closures and IIFEs".toLowerCase();
...
if (typeof window !== 'undefined') {
    window.exerciseTest = {
        ...
        testConfig: {topic: "Advanced Closures and IIFEs", language: "javascript"}
    };
}
