// Simple Browser-Compatible Test for User Management
...
function runSimpleTest(userCode) {
    ...
    try {
        ...
        const topic = "User Management".toLowerCase();
...
if (typeof window !== 'undefined') {
    window.exerciseTest = {
        ...
        testConfig: {topic: "User Management", language: "mysql"}
    };
}

console.log("✅ Test ready for: User Management");