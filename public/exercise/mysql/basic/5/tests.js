// Simple Browser-Compatible Test for Constraints and Relationships
// No external dependencies - works entirely in browser

console.log("🧪 Testing: Constraints and Relationships");
...
function runSimpleTest(userCode) {
    ...
    try {
        ...
        const topic = "Constraints and Relationships".toLowerCase();
...
if (typeof window !== 'undefined') {
    window.exerciseTest = {
        ...
        testConfig: {topic: "Constraints and Relationships", language: "mysql"}
    };
}

console.log("✅ Test ready for: Constraints and Relationships");