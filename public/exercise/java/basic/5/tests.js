// Simple Browser-Compatible Test for Arrays and Collections
...
function runSimpleTest(userCode) {
    ...
    try {
        ...
        const topic = "Arrays and Collections".toLowerCase();
...
if (typeof window !== 'undefined') {
    window.exerciseTest = {
        ...
        testConfig: {topic: "Arrays and Collections", language: "java"}
    };
}
