// Simple Browser-Compatible Test for Inheritance and Polymorphism
...
function runSimpleTest(userCode) {
    ...
    try {
        ...
        const topic = "Inheritance and Polymorphism".toLowerCase();
...
if (typeof window !== 'undefined') {
    window.exerciseTest = {
        ...
        testConfig: {topic: "Inheritance and Polymorphism", language: "java"}
    };
}
