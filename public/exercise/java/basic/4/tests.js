// Simple Browser-Compatible Test for Methods and Functions
...
function runSimpleTest(userCode) {
    ...
    try {
        ...
        const topic = "Methods and Functions".toLowerCase();
...
if (typeof window !== 'undefined') {
    window.exerciseTest = {
        ...
        testConfig: {topic: "Methods and Functions", language: "java"}
    };
}
